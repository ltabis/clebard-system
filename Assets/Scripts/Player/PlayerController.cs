...
public class PlayerController : MonoBehaviour {
    ...
    AstronomicalObject referenceBody;
    ...
    void FixedUpdate() {
        ...
        foreach (AstronomicalObject body in bodies) {
            ...
            distance = body.Position - rb.position;
            acceleration = Universe.GravitationalConstant * distance.normalized * body.mass / distance.sqrMagnitude;
